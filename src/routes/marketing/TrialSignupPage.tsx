  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-x-hidden bg-gradient-to-br from-white via-emerald-50 to-violet-50 lg:h-screen lg:overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(0,168,45,0.18) 0%, transparent 70%)",
        }}
      />
      <div
      ...
      <div className="relative mx-auto flex w-full max-w-[1140px] flex-1 flex-col lg:h-full lg:flex-row">
        ...
        <div className="flex flex-col px-8 py-10 lg:w-[52%] lg:overflow-y-auto lg:px-12 lg:py-12">
          ...
          <div className="flex-1">
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-z-green/20 bg-z-green/8 px-3.5 py-1.5">
              ...
              <span className="text-xs font-semibold text-z-text">
            ...
            <p className="mt-4 max-w-sm text-base leading-relaxed text-z-text-muted">
              Crie um catálogo digital, compartilhe o link e receba pedidos
              organizados diretamente no seu WhatsApp.
            </p>
              ...
              {STEPS.map((step) => (
                <div key={step.title} className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-sm leading-snug text-z-text-muted">
                      {step.desc}
                    </p>
                  </div>
                </div>
        ...
        <div className="relative flex flex-1 flex-col items-center justify-center px-8 py-12 lg:overflow-y-auto lg:px-14">
          <div
            id="trial-form"
            className="w-full max-w-md rounded-2xl border border-z-border bg-white p-8 shadow-z-lg"
          >
            {/* Form header */}
            <div className="mb-7">
