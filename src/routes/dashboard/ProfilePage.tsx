...
export default function ProfilePage() {
  ...
  async function handleDeleteAccount() {
    ...
    if (
      !confirm(
        "Tem certeza que deseja cancelar sua conta? Esta ação NÃO pode ser desfeita e excluirá:\n\n- Todos os dados da sua loja\n- Todos os produtos\n- Todos os clientes\n- Seu usuário\n\nDeseja continuar?",
      )
    )
      return;
    ...
    try {
      ...
      if (userEmail) {
        try {
          await fetch(
            `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/delete-user-by-email`,
            {
              method: "POST",
              headers: {
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <PhoneInput
              ...
              onChange={(value: string) =>
                form.setValue("whatsapp_phone", value)
              }
            />
      ...
      <div className="rounded-2xl border border-z-primary/30 bg-z-primary/10 p-8">
        <div className="mb-4 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-z-primary">
        ...
        <div className="rounded-xl border border-z-primary/20 bg-white p-5">
          <div className="mb-4">
            ...
            <p className="mt-1 text-sm text-z-text-muted">
              Esta ação excluirá permanentemente todos os dados da sua loja,
              produtos, clientes e seu usuário. Esta ação não pode ser desfeita.
            </p>
          </div>
