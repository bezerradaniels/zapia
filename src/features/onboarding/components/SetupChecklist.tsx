...
const TASKS: Task[] = [
  ...
  },
  {
    ...
    href: `${ROUTES.dashboardCatalog}/aparencia`,
  },
  {
    key: "hasBanner",
  ...
  {
    key: "hasColor",
    label: "Escolher a cor do catálogo",
    href: `${ROUTES.dashboardCatalog}/aparencia`,
  },
  {
    key: "hasAddress",
    label: "Adicionar seu endereço",
    href: `${ROUTES.dashboardCatalog}/gerais`,
  },
  {
    key: "hasCategory",
        ...
        {open && (
          <div className="absolute bottom-16 right-0 w-[min(calc(100vw-2.5rem),360px)] rounded-xl border border-z-border bg-white p-4 shadow-xl">
            <div className="mb-3 flex items-start justify-between gap-3">
              <div>
                <h2 className="text-sm font-semibold text-z-text">
                  Tarefas pendentes
                </h2>
              ...
              <div className="mt-3 border-t border-z-border pt-3">
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    {done} tarefa{done === 1 ? "" : "s"} concluída
                    {done === 1 ? "" : "s"}
                  </span>
                  <HugeiconsIcon
