    ...
    try {
      ...
      track("onboarding_completed", {
        ...
        total_time_seconds: Math.round(
          (Date.now() - (session.startedAt ?? Date.now())) / 1000,
        ),
      });
    ...
    >
            ...
            >
              ...
              <div
                className={cn(
                  ...
                  useCustomColor
                    ? "border-z-ink ring-2 ring-z-ink ring-offset-2"
                    : "border-slate-300",
                )}
                style={{
              ...
              >
                {!useCustomColor && (
                  <span className="text-lg leading-none text-z-text-hint">
                    +
                  </span>
                )}
                {useCustomColor && (
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <p className="text-xs text-z-text-hint">
          Proporção 1:1 recomendada. JPG, PNG ou WEBP.
        </p>
        <Controller
          name="logo_url"
          control={control}
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <p className="text-xs text-z-text-hint">
          Proporção 16:10 recomendada. JPG, PNG ou WEBP.
        </p>
        <Controller
          name="banner_url"
          control={control}
