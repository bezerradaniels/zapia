...
function toDbPayload(input: ProductInput) {
  return {
    ...
    variation_type: input.has_variations
      ? (input.variation_type ?? null)
      : null,
    variation_label: input.has_variations
      ? (input.variation_label ?? null)
      : null,
    variation_options: input.has_variations
      ? (input.variation_options ?? null)
      : null,
  };
}
