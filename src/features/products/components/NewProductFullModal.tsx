        ...
        <div className="relative border-b border-z-border bg-z-bg px-5 pb-4 pt-3">
          ...
          <div className="max-w-[728px]">
            <h2
              ...
              className="text-[28px] font-extrabold tracking-tight text-z-text"
            >
              Novo produto
            </h2>
          </div>
              ...
              <section className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <span className="text-xs text-z-text-hint">
                    Se deixar zero, o estoque não será mostrado na página do
                    produto.
                  </span>
                  {form.formState.errors.stock && (
                    <span className="text-xs text-destructive">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="flex flex-col gap-1.5">
                      ...
                      <MoneyInput
                        ...
                        onChange={(cents) =>
                          form.setValue("installment_total_in_cents", cents, {
                            shouldDirty: true,
                          })
                        }
                      />
          ...
          <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
            <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl">
              <div className="mb-5 flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-sm text-z-text-hint">
              ...
              <div className="flex flex-col gap-2">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs font-normal text-z-text-hint">
                      Confira como ficou o cadastro
                    </p>
                  </div>
                </button>
                <button
                  ...
                  onClick={() => {
                    onClose();
                    navigate(
                      `${ROUTES.dashboardProducts}/${createdProductId}?tab=info`,
                    );
                  }}
                  className="flex items-center gap-3 rounded-xl border border-z-border bg-white px-4 py-3 text-left text-sm font-medium text-z-text transition-colors hover:border-z-green hover:bg-z-sand"
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs font-normal text-z-text-hint">
                      Descrição, fotos, variações e mais
                    </p>
                  </div>
                </button>
                <button
