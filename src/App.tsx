...
const ForgotPasswordPage = lazy(
  () => import("@/routes/auth/ForgotPasswordPage"),
);
import OnboardingLayout from "@/routes/dashboard/OnboardingLayout";
const OnboardingStep1Page = lazy(
  () => import("@/routes/dashboard/OnboardingStep1Page"),
);
const OnboardingStep2Page = lazy(
  () => import("@/routes/dashboard/OnboardingStep2Page"),
);
const OnboardingStep3Page = lazy(
  () => import("@/routes/dashboard/OnboardingStep3Page"),
);
const OnboardingStep4Page = lazy(
  () => import("@/routes/dashboard/OnboardingStep4Page"),
);
const OnboardCompletePage = lazy(
  () => import("@/routes/dashboard/OnboardCompletePage"),
);
...
const EditProductPage = lazy(
  () => import("@/routes/dashboard/EditProductPage"),
);
...
const OrderConfirmationPage = lazy(
  () => import("@/routes/store/OrderConfirmationPage"),
);
import StoreAboutPage from "@/routes/store/StoreAboutPage";
const CouponRedirectPage = lazy(
  () => import("@/routes/store/CouponRedirectPage"),
);
...
const NewCustomerPage = lazy(
  () => import("@/routes/dashboard/NewCustomerPage"),
);
const CustomerDetailsPage = lazy(
  () => import("@/routes/dashboard/CustomerDetailsPage"),
);
const EditCustomerPage = lazy(
  () => import("@/routes/dashboard/EditCustomerPage"),
);
const SellersPage = lazy(() => import("@/routes/dashboard/SellersPage"));
const SellerDetailPage = lazy(
  () => import("@/routes/dashboard/SellerDetailPage"),
);
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route
          path="categorias"
          element={<Navigate to="/dashboard/catalogo/categorias" replace />}
        />
