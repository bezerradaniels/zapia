  ...
  return (
    <>
      <div className="flex flex-col gap-3">
        <p className="text-[14px] text-z-text-hint">
          As fotos serão exibidas na página "Sobre" do seu catálogo.
        </p>
        ...
        {value.length > 0 && (
          <div className="grid grid-cols-3 gap-2 sm:grid-cols-4 md:grid-cols-6">
            {value.map((url, i) => (
              <div
                key={url}
                className="group relative aspect-square w-full overflow-hidden rounded-lg border border-z-border bg-z-bg2"
              >
      ...
      {srcUrl && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4 touch-none overscroll-none">
          <div className="flex w-full max-w-xl flex-col gap-4 rounded-2xl bg-white p-6 shadow-2xl">
            ...
            <div
              className="relative h-72 overflow-hidden rounded-xl bg-neutral-900"
