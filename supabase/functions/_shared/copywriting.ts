...
const KIND_INSTRUCTIONS: Record<CopyKind, string> = {
  slogan:
    "Gere um slogan curto (até 8 palavras) para a loja. Apenas o slogan, sem aspas ou pontuação final desnecessária.",
  about:
    'Gere um texto "Sobre nós" para a página da loja, entre 2 e 4 frases, contando o que a loja vende e por que comprar nela.',
  product_description:
