...
function resolveOrigin(req: Request): string {
  ...
  if (origin === "https://zapia.app" || origin === "https://staging.zapia.app")
    return origin;
...
function jsonResponse(
  ...
  const cors = req
    ? getCorsHeaders(req)
    : { "Access-Control-Allow-Origin": "https://zapia.app", Vary: "Origin" };
...
async function resolvePriceId(
  ...
  if (period === "annual" && data.stripe_price_annual)
    return data.stripe_price_annual;
